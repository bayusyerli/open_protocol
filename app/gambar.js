 ...
 * 515 dari 14.920 produk punya gambar — 3,5%. Artinya keadaan yang LAZIM adalah tidak ada
...
function gambarBelum(p) {
  return `
    ...
    <p class="catatan">
      Gambar tersedia untuk <strong>515 dari 14.920 produk</strong> terdaftar. Kosong adalah
