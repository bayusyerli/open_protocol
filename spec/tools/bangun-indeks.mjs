...
// ---------------------------------------------------------------------------
// 749 OPT registri punya produk terdaftar; enam puluh tujuh di antaranya punya teks gejala.
...
// menyebut apa yang dilihatnya. Jadi kepala ini kecil dan dibawa utuh — enam puluh tujuh
// OPT, sekitar 27 KB — lalu dicocokkan kata per kata di peramban.
//
...
const meta = {
  ...
  tidakAda: {
    gejalaOpt:
      'Nol dari 1.360 OPT registri membawa deskripsi gejala. Yang ada hanya 67 OPT terkurasi di pest.json — 13 pintu untuk padi, 12 tomat, 12 kentang, 11 cabai, 11 bawang merah, 10 jagung, 10 kedelai, 8 kubis, 5 kakao, dengan 12 entri melayani lebih dari satu — dan seluruhnya bertekst gejala (lihat gejala.json). Di luar yang enam puluh tujuh itu jalur 1 tidak punya pintu masuk.',
