...
// ---------------------------------------------------------------------------
// 749 OPT registri punya produk terdaftar; delapan puluh di antaranya punya teks gejala.
...
// menyebut apa yang dilihatnya. Jadi kepala ini kecil dan dibawa utuh — delapan puluh
// OPT, sekitar 32 KB — lalu dicocokkan kata per kata di peramban.
//
...
const meta = {
  ...
  tidakAda: {
    gejalaOpt:
      'Nol dari 1.360 OPT registri membawa deskripsi gejala. Yang ada hanya 80 OPT terkurasi di pest.json — 13 pintu untuk padi, 12 tomat, 12 kentang, 11 cabai, 11 bawang merah, 10 jagung, 10 kedelai, 8 kubis, 8 kelapa sawit, 5 kakao, 5 kopi, dengan 12 entri melayani lebih dari satu — dan seluruhnya bertekst gejala (lihat gejala.json). Di luar yang delapan puluh itu jalur 1 tidak punya pintu masuk.',
