...
// ---------------------------------------------------------------------------
// 749 OPT registri punya produk terdaftar; enam puluh dua di antaranya punya teks gejala.
...
// menyebut apa yang dilihatnya. Jadi kepala ini kecil dan dibawa utuh — enam puluh dua
// OPT, sekitar 25 KB — lalu dicocokkan kata per kata di peramban.
//
...
const meta = {
  ...
  tidakAda: {
    gejalaOpt:
      'Nol dari 1.360 OPT registri membawa deskripsi gejala. Yang ada hanya 62 OPT terkurasi di pest.json — 13 pintu untuk padi, 12 tomat, 12 kentang, 11 cabai, 11 bawang merah, 10 jagung, 10 kedelai, 8 kubis, dengan 12 entri melayani lebih dari satu — dan seluruhnya bertekst gejala (lihat gejala.json). Di luar yang enam puluh dua itu jalur 1 tidak punya pintu masuk.',
