...
if (HRG) {
  ...
  cek('16', 'varian golongan luar (tak tampil)', gol('luar').length, 35);
  cek('16', 'berangka yang tampil di layar', HRG.filter((h) => (h.sector ?? 'pangan') !== 'luar' && h.series?.length).length, 35);
}
