...
cek('04', 'OPT registri hidup', hidup(OPTR).length, 690);
cek('04', 'OPT registri bergejala', OPTR.filter((e) => e.symptoms).length, 0);
cek('04', 'OPT terkurasi bergejala', KUR.filter((e) => e.symptoms).length, 92);
...
const BEKAS_SALAH = [
  ...
  [/778 OPT registri/, '778 OPT registri — sebenarnya 690 registri + 92 terkurasi'],
