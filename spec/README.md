...
| `stage-scale-kacang-panjang.json` | **15 fase kacang panjang** — susunan sendiri; panen berulang jadi fase tersendiri | — (beralasan) |
...
| `pest.json` | 62 OPT utama delapan komoditas semusim — padi, jagung, kedelai, kubis, cabai, bawang merah, tomat, kentang | 10 ke EPPO, semua perlu verifikasi; sisanya ke GBIF lewat entri registri yang dinaikkan, tiga tanpa pemetaan beserta alasannya |
...
| `golongan-resistensi/golongan-resistensi.ndjson` | **1.106 pemetaan bahan aktif ke kode golongan resistensi** — satu rekaman per bahan aktif yang hidup, 669 berkode dan 437 kosong beralasan; kode HRAC membawa huruf lamanya | IRAC v11.5, FRAC 2026, HRAC 2026 |
...
| Fase budidaya kacang panjang (Vigna unguiculata ssp. sesquipedalis) | 15 | 2 | 253 |
...
Empat sudah masuk. **Tembakau**, dari CORESTA Guide N° 7 — bukan kunci BBCH Monograph, melainkan
...
Dan **kacang panjang** — juga tanpa kunci terbitan, jadi disusun sendiri: 15 fase, dengan
padanan penahapan legum disebut pada tiap fase, dan jangkar hari polong dari Ofori & Klogo
(2005).
