...
| `L30` | Kolom nomor pendaftaran tidak boleh menampung teks yang bukan nomor — kekosongan dinyatakan `number_absent_in_source`, bukan dikarang jadi penanda yang terbaca sebagai izin edar |
