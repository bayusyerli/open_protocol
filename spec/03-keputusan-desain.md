...
| 24 | 117 baris label non-gulma masih di luar jalur 1 (1,7%) | Dipilah, dan pilahannya berubah bentuk sesudah kurasi 144. **64** pada komoditas yang belum punya pintu sama sekali — separuhnya entitas FASE (pembibitan kelapa sawit, pembibitan teh, tembakau di persemaian) yang sengaja tidak disatukan ke tanamannya, separuhnya tanaman yang belum dikurasi (cengkeh, terung, anggrek, nenas). **40** OPT yang belum berpintu pada tanaman yang sudah berpintu, terpusat di jeruk (9) dan jagung (7), tiap satunya satu baris — pekerjaan agronomi satu per satu, dan tiga di antaranya tertahan sebab yang bisa disebut: `Xanthomonas campestris` sudah dicakup pintu padi sehingga menaikkannya jadi pintu kubis akan mencabut tujuh baris padi, dan `Thrips sp.` sasaran bertingkat marga yang justru jadi SUMBER pencakupan sehingga menaikkannya akan memutus jangkauan pintu trips yang lain. **13** memang bukan komoditas pertanian |
