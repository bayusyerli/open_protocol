...
| 24 | 224 baris label non-gulma masih di luar jalur 1 (3,3%) | Sudah dipilah dan tidak lagi satu tumpukan. **144** OPT yang belum berpintu pada tanaman yang sudah berpintu — tiap satunya menuntut teks gejala dan dua ciri yang bisa diperiksa sendiri, dan sebarannya rata satu sampai tiga baris, jadi yang tersisa memang pekerjaan agronomi satu per satu. **67** pada komoditas yang belum punya pintu sama sekali: separuhnya entitas FASE (pembibitan kelapa sawit, pembibitan teh, tembakau di persemaian) yang sengaja tidak disatukan ke tanamannya, separuhnya tanaman yang belum dikurasi (cengkeh, terung, anggrek, nenas). **13** memang bukan komoditas pertanian — "Kebutuhan Export", padang rumput golf, kandang ayam — dan tidak akan pernah punya pintu di sini |
