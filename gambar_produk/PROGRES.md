# Kemajuan panen gambar kemasan

Dibangkitkan `progres.py`. Jangan disunting tangan — jalankan ulang.

## Corong

| Tahap | Merek | Dari | |
|---|---:|---:|---|
| Terdaftar di registri | 10.978 | 10.978 | `████████████████████████` 100.0% |
...
| Sudah dicoba dipanen | 630 | 10.978 | `█·······················` 5.7% |
| **Bergambar** | 552 | 10.978 | `█·······················` 5.0% |
...
| Baris manifes | 676 |
| Merek bergambar | 552 |
| Merek ditolak beralasan | 78 |
| Berkas ternormalkan | 1.560 |
| Ukuran total | 70.8 MB |
| Dipersempit ke satu pendaftaran | 572 baris |

Peran gambar: **550** kemasan_depan · **38** panel_label · **6** lainnya · **3** logo · **1** bidikan_produk

## Kekuatan bukti

| Ukuran | Jumlah | Catatan |
|---|---:|---|
| Nomor pendaftaran terbaca dari gambar | 291 | |
| …ada di registri | 275 | selisih 16 tidak ada |
| …**dan** milik mereknya sendiri | 270 | selisih 5 milik merek lain |
| `komposisi_terbaca` | 385 | |
| `tampak_sintetis` | 134 | |
| `bentuk_kemasan_generik` | 126 | |
| `watermark` | 14 | |
| `overlay_promosi` | 13 | |
| `penambal` | 3 | |

## Principal yang sudah dipanen

| Principal | Bergambar | Merek | | Situs |
|---|---:|---:|---|---|
| PT Petrokimia Kayaku | 70 | 91 | `███████████···` | https://petrokayaku.com |
...
| PT. RAINBOW AGROSCIENCES | 19 | 181 | `█·············` | rainbowagro.com/id |
...
| Status | Principal | Merek | Artinya |
|---|---:|---:|---|
| `belum-diperiksa` | 1.749 | 3.427 | belum disentuh sapuan |
| `ada` | 58 | 2.846 | galeri layak panen |
| `tidak-ada` | 54 | 1.365 | tidak pernah punya situs |
| `tipis` | 32 | 1.393 | galeri kecil atau resolusi rendah |
| `rusak` | 24 | 717 | situs ada tapi tak berfungsi |
| `kosong` | 20 | 816 | situs sehat, gambar belum diunggah — **periksa ulang berkala** |
| `mati` | 7 | 299 | domain bukan milik principal lagi |
| `surat-saja` | 6 | 115 | domain hidup tetapi hanya melayani surat — **domainnya sudah ketemu** |

**Sisa: 10.463 merek.** Prospek yang sudah dipetakan dan tinggal dipanen ada di [`PANDUAN-PANEN.md`](PANDUAN-PANEN.md) pasal 13.
