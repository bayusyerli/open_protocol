...
| Sudah dicoba dipanen | 884 | 10.978 | `██······················` 8.1% |
| **Bergambar** | 804 | 10.978 | `██······················` 7.3% |
...
| Baris manifes | 947 |
| Merek bergambar | 804 |
| Merek ditolak beralasan | 80 |
| Berkas ternormalkan | 2.291 |
| Ukuran total | 96.8 MB |
| Dipersempit ke satu pendaftaran | 853 baris |

Peran gambar: **801** kemasan_depan · **55** panel_label · **6** lainnya · **3** logo · **1** bidikan_produk

## Kekuatan bukti

| Ukuran | Jumlah | Catatan |
|---|---:|---|
| Nomor pendaftaran terbaca dari gambar | 398 | |
| …ada di registri | 382 | selisih 16 tidak ada |
| …**dan** milik mereknya sendiri | 377 | selisih 5 milik merek lain |
| `komposisi_terbaca` | 515 | |
| `tampak_sintetis` | 192 | |
| `bentuk_kemasan_generik` | 180 | |
| `watermark` | 14 | |
| `overlay_promosi` | 13 | |
| `penambal` | 3 | |
...
|---|---:|---:|---|---|
| PT. SINAR GENERAL INDUSTRIES | 91 | 129 | `██████████····` | https://pt-sgi.com |
| PT. CENTA BRASINDO ABADI CHEMICAL INDUST | 85 | 194 | `██████········` | katalogcba.com |
...
|---|---:|---:|---|
| `belum-diperiksa` | 1.189 | 1.249 | belum disentuh sapuan |
| `tidak-ada` | 394 | 2.634 | tidak pernah punya situs |
| `ada` | 115 | 3.112 | galeri layak panen |
| `tipis` | 115 | 1.758 | galeri kecil atau resolusi rendah |
| `kosong` | 71 | 974 | situs sehat, gambar belum diunggah — **periksa ulang berkala** |
| `rusak` | 35 | 770 | situs ada tapi tak berfungsi |
...
**Sisa: 10.389 merek.** Prospek yang sudah dipetakan dan tinggal dipanen ada di [`PANDUAN-PANEN.md`](PANDUAN-PANEN.md) pasal 13.
