...
3. **Situs tidak ikut terbangun.** Push dari GitHub Actions memakai `GITHUB_TOKEN` tidak
   memicu workflow lain, jadi commit harian tidak membangun ulang situs. Per hari ini itu belum
   jadi soal sama sekali: jalur tayangnya (`situs.yml`) masih di cabang tema dan belum sampai ke
   `main`. Selama situsnya masih artefak dan hostnya belum dipilih, ini tidak merugikan apa pun;
   begitu host dipilih, jalur tayangnya diurus di `situs.yml`, bukan diakali dari sini.
