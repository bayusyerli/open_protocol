...
|---|---|---|---|
| **1 · Insiden** — gejala → OPT → bahan | Pestisida | 23.058 penggunaan berlabel, 96,1% tertaut OPT, 80% berdosis | ✕ Diagnosis. Nol dari 1.360 OPT punya deskripsi gejala — enam kalimat harus ditulis tangan |
...
|---|---|---|
| **Deskripsi gejala OPT** — 0 dari 1.360 | Jalur 1 tidak punya pintu masuk | Kurasi · enam kalimat untuk cabai |
