...
|---|---|
| **Ini apa?** | **Nyaris nol.** Dari 719 OPT registri tidak satu pun punya deskripsi gejala; yang ada hanya 62 OPT terkurasi — delapan komoditas semusim, dengan 12 entri melayani lebih dari satu — seluruhnya bertekst |
...
- **Masuk lewat apa yang terlihat, bukan nama hama.** Petani yang panik tidak tahu
  kata "trips". Ia tahu daunnya mengeriting ke atas. Delapan komoditas sudah punya
  pintunya — 62 OPT terkurasi, seluruhnya bertekst.
...
- ~~**Sepuluh OPT itu tidak terbatas pada cabai.**~~ **Terbukti, dan dipakai.** Registri
  ...
  kedua sampai kedelapan menyusul 28 Agustus 2026: **11 pintu bawang merah, 12 tomat,
  12 kentang, 13 padi, 10 jagung, 8 kubis, 10 kedelai**, lima puluh dua entri baru yang
  dinaikkan dari registri ditambah entri lama yang teks gejalanya dibuka berklausa per
  tanaman. Seluruhnya 62 OPT terkurasi bergejala, 12 di antaranya melayani lebih dari satu
  komoditas.
