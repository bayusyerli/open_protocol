...
|---|---|
| **Ini apa?** | **Nyaris nol.** Dari 714 OPT registri tidak satu pun punya deskripsi gejala; yang ada hanya 67 OPT terkurasi — delapan komoditas semusim ditambah kakao, dengan 12 entri melayani lebih dari satu — seluruhnya bertekst |
...
- **Masuk lewat apa yang terlihat, bukan nama hama.** Petani yang panik tidak tahu
  kata "trips". Ia tahu daunnya mengeriting ke atas. Sembilan komoditas sudah punya
  pintunya — 67 OPT terkurasi, seluruhnya bertekst.
...
- ~~**Sepuluh OPT itu tidak terbatas pada cabai.**~~ **Terbukti, dan dipakai.** Registri
  ...
  berklausa per tanaman. Seluruhnya 67 OPT terkurasi bergejala, 12 di antaranya melayani
  lebih dari satu komoditas. Kakao tanaman TAHUNAN pertama, dan skala fase yang belum ada
  ternyata tidak menghalangi jalur 1 sama sekali — ia prasyarat Lapis 2, bukan prasyarat
  pintu gejala.
