...
| # | Kapabilitas | Untuk siapa | Keputusan yang diubah | Keadaan data | Putusan |
|---|---|---|---|---|---|
| C1 | Registri input terdaftar — pupuk, pestisida, benih | semua | #3, #4, #6, #9 | **selesai** — 14.920 produk, 11.227 varietas, dan sejak 23 Agustus 2026 **3.135 badan pemegang** beserta halaman profilnya | **selesai** |
