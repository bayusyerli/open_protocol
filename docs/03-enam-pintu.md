...
|---|---|---|---|
| **1 · Insiden** — gejala → OPT → bahan | Pestisida | 23.058 penggunaan berlabel, 96,1% tertaut OPT, 80% berdosis | ✕ Diagnosis. Nol dari 783 OPT registri punya deskripsi gejala; 5 dari 10 OPT terkurasi punya — lima kalimat lagi harus ditulis tangan |
...
|---|---|---|
| **Deskripsi gejala OPT** — 0 dari 783 registri, 5 dari 10 terkurasi | Jalur 1 baru punya lima pintu masuk | Kurasi · lima kalimat lagi untuk cabai |
