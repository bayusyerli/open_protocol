...
|---|---|---|---|
| **1 · Insiden** — gejala → OPT → bahan | Pestisida | 23.058 penggunaan berlabel, 96,1% tertaut OPT, 80% berdosis; 176 OPT terkurasi bergejala di 38 komoditas, masing-masing dua ciri pembanding; rincian per komoditas di [14-tinjauan-gejala.md](14-tinjauan-gejala.md) | ✕ Diagnosis. Nol dari 545 OPT **registri** punya deskripsi gejala, jadi pintunya sebanyak yang terkurasi saja |
...
|---|---|---|
| **Deskripsi gejala OPT** — 0 dari 545 OPT registri; seluruh yang terkurasi sudah ditulis | Jalur 1 hanya berpintu untuk komoditas yang sudah dikurasi; daftarnya di [14-tinjauan-gejala.md](14-tinjauan-gejala.md) | Kurasi · komoditas berikutnya, dan peninjauan penyuluh atas yang sudah ditulis |
